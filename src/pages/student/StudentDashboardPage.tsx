...
export const StudentDashboardPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-brand-primary border-t-brand-accent rounded-full animate-spin mx-auto mb-4" />
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-16">
      {/* Header Banner */}
      <div className="bg-brand-primary text-white py-12 px-4 sm:px-6 lg:px-8 border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/student/profile"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-brand-accent hover:bg-brand-accent-hover text-brand-primary font-bold text-sm transition-all shadow-md shadow-brand-accent/20"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-8 border-t border-white/10">
            ...
            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-xl border border-white/10">
              ...
              <div className="text-2xl font-black text-brand-accent mt-1">{inProgressCourses}</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-xl border border-white/10">
            ...
            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-xl border border-white/10">
              ...
              <div className="text-2xl font-black text-brand-accent mt-1">{totalCertificates}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        {enrollments.length === 0 ? (
          <div className="bg-white rounded-2xl p-10 text-center border border-slate-200 shadow-sm max-w-xl mx-auto">
            <div className="w-16 h-16 bg-brand-primary/5 rounded-2xl flex items-center justify-center text-brand-primary mx-auto mb-4">
            ...
            <Link
              to="/#formations"
              className="inline-flex items-center gap-2 px-6 py-3 bg-brand-primary text-white font-bold rounded-xl hover:bg-brand-primary-light transition-all shadow-md"
            >
              ...
              return (
                ...
                >
                  <div className="relative h-48 overflow-hidden bg-slate-900">
                    ...
                    <span className="absolute top-3 left-3 bg-brand-primary/90 text-brand-accent text-xs font-bold px-2.5 py-1 rounded-lg backdrop-blur-sm border border-brand-accent/20">
                      {course.category}
                    </span>
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="text-lg font-black text-brand-primary group-hover:text-brand-accent-hover transition-colors line-clamp-2">
                        {course.title}
                      </h3>
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-100">
                      ...
                      <div className="mt-5 flex items-center justify-between">
                        <Link
                          ...
                          className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-brand-primary hover:bg-brand-primary-light text-white font-bold text-xs transition-all shadow-md group/btn"
                        >
